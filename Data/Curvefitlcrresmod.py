...
def fit_function(x, Ares,fres,gamma,back):
    return  Ares / np.sqrt(1 + (2*np.pi/(gamma*x))**2 * (x**2-fres**2)**2)+back*x
...
param_names = ['amplitude','resonant frequency','gamma width','backgraound']
